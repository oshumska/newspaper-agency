...
from redaction.views import (
    ...
    NewspaperDetailView,
    NewspaperUpdateView,
    RedactorUpdateYearsOfExperience,
    TopicDeleteView,
    RedactorDeleteView,
)
...
urlpatterns = [
    ...
    path("redactor/<int:pk>/update-experience/", RedactorUpdateYearsOfExperience.as_view(), name="update-experience"),
    path("redactor/<int:pk>/delete/", RedactorDeleteView.as_view(), name="delete-redactor"),
